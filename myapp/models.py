...
class Ranking (models.Model):
    ...
    game_played = models.IntegerChoices()
    games_won = models.IntegerChoices()
    games_lost = models.IntegerChoices()
    games_drawn = models.IntegerChoices()
    point_taken = models.IntegerField()
    rank = models.IntegerChoices()
